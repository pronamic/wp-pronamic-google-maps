...
<div id="<?php echo esc_attr( $this->get_field_id( 'pgm' ) ); ?>" class="pronamic-google-maps-widget">
	...
	<p>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'static-false' ) ); ?>"><?php _e( 'Dynamic', 'pronamic_google_maps' ); ?></label>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'static-true' ) ); ?>"><?php _e( 'Static', 'pronamic_google_maps' ); ?></label>
	</p>
</div>
