...
<div id="<?php echo esc_attr( $this->get_field_id( 'pgm' ) ); ?>" class="pronamic-google-maps-widget">
	...
	<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>">
			<?php esc_html_e( 'Title', 'pronamic_google_maps' ); ?>:
		</label>
	...
	<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>">
			<?php esc_html_e( 'Description', 'pronamic_google_maps' ); ?>:
		</label>
	...
	<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'latitude' ) ); ?>">
			<?php esc_html_e( 'Latitude', 'pronamic_google_maps' ); ?>:
		</label>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'longitude' ) ); ?>">
			<?php esc_html_e( 'Longitude', 'pronamic_google_maps' ); ?>:
		</label>
	...
	<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>">
			<?php esc_html_e( 'Width', 'pronamic_google_maps' ); ?>:
		</label>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>">
			<?php esc_html_e( 'Height', 'pronamic_google_maps' ); ?>:
		</label>
	...
	<p>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'static-false' ) ); ?>"><?php esc_html_e( 'Dynamic', 'pronamic_google_maps' ); ?></label>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'static-true' ) ); ?>"><?php esc_html_e( 'Static', 'pronamic_google_maps' ); ?></label>
	</p>
</div>
