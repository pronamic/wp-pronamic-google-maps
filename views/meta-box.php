...
<div id="pgm">
	...
	<table class="form-table">
		<tr>
			<th scope="row">
				<label for="pgm-active-field"><?php esc_html_e( 'Active', 'pronamic_google_maps' ); ?></label>
			</th>
			<td>
				<input id="pgm-active-field" name="_pronamic_google_maps_active" value="true" type="checkbox" <?php checked( $pgm->active ); ?> />
				<label for="pgm-active-field"><?php esc_html_e( 'Show Google Maps', 'pronamic_google_maps' ); ?></label>
			</td>
		</tr>
		<tr>
			<th scope="row">
		...
		<tr>
			<th scope="row">
				<label for="pgm-description-field"><?php esc_html_e( 'Description', 'pronamic_google_maps' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<?php esc_html_e( 'Geocoder', 'pronamic_google_maps' ); ?>
			</th>
			<td>
				<input id="pgm-geocode-button" type="submit" value="<?php esc_attr_e( 'Geocode &darr;', 'pronamic_google_maps' ); ?>" class="button" name="pgm_geocode" />
		...
		<tr>
			<td colspan="2">
				<span class="description"><?php esc_html_e( 'Tip: Change the zoom level and map type to your own wishes.', 'pronamic_google_maps' ); ?></span>
			</td>
		</tr>
	</table>
