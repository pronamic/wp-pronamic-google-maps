...
foreach ( $collection as $log ) {
	if ( $collection->hasNext() ) {
		...
		if ( 'Unreleased' === $log->version ) {
			echo '[unreleased]: https://github.com/pronamic/wp-pronamic-google-maps/compare/', $prev->version, '...', 'HEAD', "\r\n";     
		} else {
			echo '[', $log->version, ']: https://github.com/pronamic/wp-pronamic-google-maps/compare/', $prev->version, '...', $log->version, "\r\n";     
		}
	}
}
