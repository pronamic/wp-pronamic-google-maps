...
Tags: google maps, geo, v3, api, custom types, latitude
...
The nice thing about this plugin that developers can configure on wich post type the meta box should be visible. Developers can activate the meta box for every custom post type they registered with the [register\_post\_type function][1].
...
2. The metabox where you can easilu manage the GEO meta data.
